...
const AUTHORITY_GUARDS = [
  ...
  { pkg: "@getsimpledirect/vinci-model-classes", export: "selectForRole", label: "selectForRole(hostile role, valid endpoints, now)", call: (fn, hostile) => fn(hostile, [], "2026-08-26T12:00:00.000Z").eligible.length > 0, control: (fn) => fn({ schemaVersion: 1, roleId: "r", taskClass: "t", requiredCapabilities: [], minimumContextTokens: 1000, riskClass: "low", dataPolicy: { externalProviderAllowed: true, outputRetentionAllowed: false, processesProtectedData: false }, qualityPolicy: { minimumVerifiedSuccessRate: 0.5, maximumFalseClaimRate: 0.1 }, economicPolicy: { maximumCostPerVerifiedSuccessUsd: 1.0, maximumP95WallSeconds: 10 }, fallbackRoleIds: [] }, [], "2026-08-26T12:00:00.000Z").eligible.length === 0 },
  { pkg: "@getsimpledirect/vinci-model-classes", export: "selectForRole", label: "selectForRole(valid role, hostile endpoints, now)", call: (fn, hostile) => fn({ schemaVersion: 1, roleId: "r", taskClass: "t", requiredCapabilities: [], minimumContextTokens: 1000, riskClass: "low", dataPolicy: { externalProviderAllowed: true, outputRetentionAllowed: false, processesProtectedData: false }, qualityPolicy: { minimumVerifiedSuccessRate: 0.5, maximumFalseClaimRate: 0.1 }, economicPolicy: { maximumCostPerVerifiedSuccessUsd: 1.0, maximumP95WallSeconds: 10 }, fallbackRoleIds: [] }, hostile, "2026-08-26T12:00:00.000Z").eligible.length > 0, control: (fn) => fn({ schemaVersion: 1, roleId: "r", taskClass: "t", requiredCapabilities: [], minimumContextTokens: 1000, riskClass: "low", dataPolicy: { externalProviderAllowed: true, outputRetentionAllowed: false, processesProtectedData: false }, qualityPolicy: { minimumVerifiedSuccessRate: 0.5, maximumFalseClaimRate: 0.1 }, economicPolicy: { maximumCostPerVerifiedSuccessUsd: 1.0, maximumP95WallSeconds: 10 }, fallbackRoleIds: [] }, [], "2026-08-26T12:00:00.000Z").eligible.length === 0 },
